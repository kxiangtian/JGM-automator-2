...
def Assign_Position(Ss):
	...
	if Ss == "16.0:9":
		...
		FEATURES = {
		"P_NoMoreTrain":(531/1080,1753/2248),
		"P_Train": (413/1080,1952/2248),
		"B_Upgrade" : (1059/1080,1367/2248),
		"B_Store" : (562/1080,2087/2248),
		"B_Build" : (181/1080,2142/2248),
		"B_Task" : (258/1080,1763/2248),
		"B_Policy" : (221/1080,403/2248),
		"R_gold": AREA(247,128,407,190),
		"R_Names" : AREA(339,1680,819,1755),
		"R_Levels" : AREA(339,1688,471,1750),
		"B_Finish_Task":(542/1080,1795/2248),  
		"B_Upgrade_B" :(880/1080,2094/2248),
		"B_NoMoreTrain":(360/1080,1596/2248),
		"P_redpacket":[(289/1080,758/2248),(626/1080,758/2248),(951/1080,758/2248),(625/1080,1450/2248)]
		}
	elif Ss == 2:
		BUILDING_POSITIONS = {
